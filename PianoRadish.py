...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if Ya1 > 325 and Ya1 < 450 or Ya2 > 325 and Ya2 < 450 or Ya3 > 325 and Ya3 < 450 or Ya4 > 325 and Ya4 < 450 or Ya5 > 325 and Ya5 < 450:
                if Ya1 > 550 or Ya2 > 550 or Ya3 > 550 or Ya4 > 550 or Ya5 > 550:
    ...
    tilespersecond = 45/(45.242-5.296)
    seconds = int(pygame.time.get_ticks()) /1000 -5.296
    realscore =  tilespersecond * seconds
    

    score = block1 + block2+ block3 + block4 
    
    if  int(pygame.time.get_ticks()) > 7 and (score > realscore + 3 or score < realscore - 3) :
        game_over()
        print(int(pygame.time.get_ticks()))
